...
var Icon$v = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: 90, height: 90, href: "/images/dry/logo.png" })));
};
...
var SpinnerIcon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 500 500" }, props),
        React.createElement("image", { width: "96", height: "96", href: "/images/dry/logo.png" })));
};
...
var Icon$J = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 591 591" }, props),
        ...
        React.createElement("g", { id: "#1d99ccff" },
            React.createElement("path", { fill: "#1d99cc", opacity: "1.00", d: " M 250.21 204.23 C 256.08 198.23 262.04 192.30 268.04 186.42 C 268.72 197.12 267.79 207.87 268.69 218.56 L 268.71 218.83 C 265.17 222.91 259.20 225.22 254.08 222.75 C 246.94 219.98 244.84 209.64 250.21 204.23 Z" }),
            React.createElement("path", { fill: "#1d99cc", opacity: "1.00", d: " M 419.81 209.88 C 427.94 213.41 434.60 220.31 437.32 228.81 C 439.22 234.01 438.71 239.62 438.75 245.04 C 438.76 267.20 438.73 289.36 438.76 311.52 C 432.82 307.62 426.37 304.48 419.51 302.56 L 419.52 302.41 C 420.04 271.57 419.47 240.72 419.81 209.88 Z" }),
            React.createElement("path", { fill: "#1d99cc", opacity: "1.00", d: " M 152.38 227.24 C 154.55 225.04 157.48 223.91 160.37 222.97 L 160.41 224.04 C 160.74 233.96 160.45 243.89 160.59 253.82 C 156.92 252.88 153.25 251.21 150.93 248.09 C 146.09 242.11 146.70 232.48 152.38 227.24 Z" }),
            React.createElement("path", { fill: "#1d99cc", opacity: "1.00", d: " M 230.56 231.62 C 236.32 237.48 239.79 245.47 239.87 253.72 C 236.50 253.75 233.14 253.77 229.78 253.77 C 230.58 246.40 230.09 238.99 230.56 231.62 Z" }),
            React.createElement("path", { fill: "#1d99cc", opacity: "1.00", d: " M 117.25 352.06 C 115.64 332.97 121.60 313.36 133.60 298.42 C 133.99 301.26 134.35 304.13 134.39 307.01 C 134.31 328.65 134.42 350.30 134.35 371.95 C 134.29 379.40 134.59 386.87 134.06 394.32 C 124.29 382.41 118.38 367.42 117.25 352.06 Z" }),
            React.createElement("path", { fill: "#1d99cc", opacity: "1.00", d: " M 256.30 301.68 C 267.08 316.67 271.95 335.72 269.99 354.06 C 268.72 367.08 263.91 379.71 256.36 390.38 C 255.59 382.61 256.28 374.80 255.86 367.01 C 256.46 351.00 255.46 335.00 255.96 319.00 C 255.98 313.22 255.62 307.43 256.30 301.68 Z" }),
            React.createElement("path", { fill: "#1d99cc", opacity: "1.00", d: " M 346.73 366.93 C 346.97 355.20 351.38 343.73 358.72 334.62 C 359.79 348.72 358.99 362.88 359.25 377.01 C 359.10 385.49 359.69 394.00 358.68 402.44 C 350.59 392.55 346.25 379.70 346.73 366.93 Z" }),
            React.createElement("path", { fill: "#1d99cc", opacity: "1.00", d: " M 444.42 337.65 C 457.34 355.58 457.34 381.44 444.50 399.42 C 443.23 389.33 444.04 379.15 443.82 369.01 C 443.98 358.56 443.33 348.07 444.42 337.65 Z" })),
...
var Icon$Y = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 591 591" }, props),
        ...
        React.createElement("g", { id: "#1d99ccff" },
            React.createElement("path", { fill: "#1d99cc", opacity: "1.00", d: " M 411.47 199.62 C 419.64 207.75 427.78 215.90 435.92 224.06 C 438.95 226.81 438.88 232.06 435.83 234.77 C 427.68 242.96 419.52 251.12 411.33 259.27 C 411.18 239.39 410.90 219.50 411.47 199.62 Z" }),
            React.createElement("path", { fill: "#1d99cc", opacity: "1.00", d: " M 164.42 218.41 C 169.81 213.03 177.91 214.70 184.75 214.51 C 184.67 224.42 184.64 234.33 184.76 244.24 C 178.37 243.91 171.07 245.70 165.59 241.45 C 158.20 236.28 157.48 224.27 164.42 218.41 Z" }),
            React.createElement("path", { fill: "#1d99cc", opacity: "1.00", d: " M 150.29 342.37 C 159.81 332.78 169.37 323.22 178.97 313.70 C 179.46 336.52 179.27 359.35 179.07 382.18 C 169.34 372.48 159.62 362.78 149.93 353.04 C 146.93 350.21 147.33 345.09 150.29 342.37 Z" })),
